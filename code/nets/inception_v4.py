...
#          end_points['PreLogitsFlatten'] = net
          # 1536
          #ll = slim.fully_connected(net, 10, activation_fn=None, scope='Logits0')
          #ll = tf.reduce_max(ll, keep_dims=True, axis=1)
          ...
          #ll = tf.nn.sigmoid(ll)
#          logits_1 = slim.fully_connected(net, 1, activation_fn=None, scope='Logits1')
#          logits = tf.concat([logits_0,logits_1],axis=1)          
